...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecommendationList'
        db.create_table('recommendation_item_recommendationlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('recommendation_item', ['RecommendationList'])

        # Adding M2M table for field recommendation_list on 'RecommendationItem'
        db.create_table('recommendation_item_recommendationitem_recommendation_list', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recommendationitem', models.ForeignKey(orm['recommendation_item.recommendationitem'], null=False)),
            ('recommendationlist', models.ForeignKey(orm['recommendation_item.recommendationlist'], null=False))
        ))
        db.create_unique('recommendation_item_recommendationitem_recommendation_list', ['recommendationitem_id', 'recommendationlist_id'])


    def backwards(self, orm):
        # Deleting model 'RecommendationList'
        db.delete_table('recommendation_item_recommendationlist')

        # Removing M2M table for field recommendation_list on 'RecommendationItem'
        db.delete_table('recommendation_item_recommendationitem_recommendation_list')
