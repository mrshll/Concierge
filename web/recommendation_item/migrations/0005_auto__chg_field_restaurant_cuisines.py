...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Restaurant.cuisines'
        db.alter_column('recommendation_item_restaurant', 'cuisines', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):

        # Changing field 'Restaurant.cuisines'
        db.alter_column('recommendation_item_restaurant', 'cuisines', self.gf('utility.models.SeparatedValuesField')(null=True))
    ...
    models = {
        ...
        'recommendation_item.restaurant': {
            ...
            'cuisines': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
