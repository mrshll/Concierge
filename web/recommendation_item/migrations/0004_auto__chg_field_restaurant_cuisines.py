...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Restaurant.cuisines'
        db.alter_column('recommendation_item_restaurant', 'cuisines', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'recommendation_item.restaurant': {
            ...
            'cuisines': ('utility.models.SeparatedValuesField', [], {'null': 'True', 'blank': 'True'}),
